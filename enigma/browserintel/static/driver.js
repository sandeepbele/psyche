...
`;
    ...
    function getCSSMedia() {
        ...
        try {
            ...
            const { body } = win.document.cloneNode(false);
    ...
    */
    ...
    async function getCreep(fp) {
        ...
        function hardenEntropy(workerScope, data) {
        ...
        function hardenGPU(canvasWebgl) {
        ...
        const creep = {
            ...
            workerScope: !fp.workerScope || fp.workerScope.lied ? undefined : {
                deviceMemory: (fp.braveFingerprintingBlocking ? undefined : fp.workerScope.deviceMemory),
                hardwareConcurrency: (fp.braveFingerprintingBlocking ? undefined : fp.workerScope.hardwareConcurrency),
            ...
            canvasWebgl: (!fp.canvasWebgl || fp.canvasWebgl.lied || LowerEntropy.WEBGL) ? undefined : (fp.braveFingerprintingBlocking ? {
                parameters: {
            ...
            cssMedia: !fp.cssMedia ? undefined : {
                ...
                colorScheme: (fp.braveFingerprintingBlocking ? undefined :
    ...
    async function getFingerprintData(url) {
...
})(typeof exports === 'undefined' ? this.driver = {} : exports);
